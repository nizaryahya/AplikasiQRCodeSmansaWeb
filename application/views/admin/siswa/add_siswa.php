                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="<?= site_url('siswa/create') ?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="ttl" class="form-control" name="ttl" placeholder="Tempat, Tanggal Lahir">
                                    </div>
                                    <div class="form-group">
                                        <label for="InputJenisKelamin">Jenis Kelamin</label>
                                        <input type="jeniskelamin" class="form-control" name="jeniskelamin" placeholder="Jenis Kelamin">
                                     </div>
                                    <div class="form-group">
