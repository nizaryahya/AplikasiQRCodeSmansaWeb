                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="card card-info">
                            ...
                            <form action="<?= site_url('guru/update') ?>" method="post">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" name="id" placeholder="id" value="<?= $d->id_guru ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jabatan" placeholder="Jabatan" value="<?= $d->jabatan ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <a href="<?= site_url('guru') ?>" class="btn btn-secondary" title="back"><i class="fas fa-reply"></i></a>
